...
<div class="page-header">
    ...
    <a href="${pageContext.request.contextPath}/autores?action=novo" class="btn btn-primary-custom">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="${pageContext.request.contextPath}/autores?action=deletar&id=${autor.id}"
